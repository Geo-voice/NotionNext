...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.youtube.com/@WarmVoice1978', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'dubbing, voice actor', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'xinshun.okinawa@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'www.youtube.com/@WarmVoice1978', // Youtube主页
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || '197879.xyz', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
